...
export default function App() {
  ...
  if (authLoading) return <div style={{ height:"100vh", display:"flex", alignItems:"center", justifyContent:"center", background:"#050508" }}><div className="spinner" style={{ width:48, height:48, borderWidth:3 }} /></div>;
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        :root { --bg:#03030a; --panel:#08080f; --card:#0e0e1a; --card2:#131320; --border:rgba(255,255,255,0.05); --border2:rgba(255,255,255,0.1); --accent:#e8c14a; --accent2:#f5d97a; --accent-dim:rgba(232,193,74,0.1); --accent-glow:rgba(232,193,74,0.25); --green:#2ecc71; --red:#e74c3c; --text:#eeeef5; --muted:#44445a; --muted2:#7777a0; --sidebar:280px; }
        ...
        .sidebar-brand { padding:22px 20px 16px; border-bottom:1px solid var(--border); display:flex; align-items:center; gap:10px; }
        ...
        .gen-btn { width:100%; padding:14px; background:var(--accent); border:none; border-radius:13px; color:#03030a; font-family:'Bebas Neue',sans-serif; font-size:18px; letter-spacing:2px; cursor:pointer; transition:all .2s; box-shadow:0 6px 24px var(--accent-glow); display:flex; align-items:center; justify-content:center; gap:8px; }
        ...
        .canvas { flex:1; display:flex; flex-direction:column; align-items:center; justify-content:center; padding:28px; gap:16px; overflow-y:auto; scrollbar-width:none; }
        ...
        .login-tagline { font-size:14px; color:var(--muted2); text-align:center; font-weight:300; }
          ...
          {view === "create" && (
            <div className="workspace">
              <div className="controls">
                  ...
                  <div className="ctrl-section">
                    ...
                    <div className="prompt-wrap">
                      <textarea value={prompt} onChange={e => setPrompt(e.target.value.slice(0,500))}
                        placeholder={activeTool.id === "text-to-audio" ? "Describe the music or sound you want..." : activeTool.id === "image-to-video" ? "Describe how to animate this image..." : "Describe what you want to create..."}
                        rows={4} />
                ...
                {needsImageInput && (
                  <div className="ctrl-section">
                    ...
                    {inputImageUrl && <img src={inputImageUrl} alt="" className="uploaded-preview" onError={e => e.target.style.display="none"} />}
                  </div>
                )}
                ...
                {creditsLeft < activeTool.credits && !loading && <div style={{ fontSize:11, color:"var(--red)", textAlign:"center" }}>Not enough credits. Resets at midnight.</div>}
              </div>
              <div className="canvas">
                ...
                {loading && <div className="loading-card"><div className="spinner" /><div className="loading-label">GENERATING...</div><div className="loading-sub-text">This may take 10–30 seconds</div></div>}
