      ...
      <div className="app">
        <aside className={"sidebar"+(sidebarOpen?" open":"")}>
          ...
          <div className="sidebar-views">
            <div className={"view-btn"+(view==="chat"?" active":"")} onClick={()=>{ setView("chat"); setSidebarOpen(false); }} style={{background:view==="chat"?"rgba(0,212,255,0.08)":"",borderColor:view==="chat"?"rgba(0,212,255,0.2)":""}}>
              <span className="view-icon" style={{color:view==="chat"?"var(--cyan)":""}}>◈</span>
              <span className="view-lbl" style={{color:view==="chat"?"var(--text)":""}}>AI Assistant</span>
              <span style={{fontSize:9,background:"linear-gradient(135deg,var(--cyan),var(--purple))",color:"#fff",padding:"2px 6px",borderRadius:100,fontWeight:700,letterSpacing:1}}>NEW</span>
            </div>
        ...
        <main className="main">
          ...
          {view==="chat" && <AIChat userName={user.displayName}/>}
        </main>
      </div>
    </>
  );
